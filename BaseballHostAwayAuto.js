// ==UserScript==
// @name         PNW - Baseball Host/Away Auto [v3]
...
// @updateURL    https://raw.githubusercontent.com/michalani/PNW-Scripts/master/BaseballHostAuto.user.js
...
function fetchAPIKey(){
    ...
    if(req.status == 200) {
        //parse it..
        return (req.responseText.split('<td class=\'center\'>')[2].split('</td>')[0]);
    } else {
        return null;
    }
...
if(localStorage.getItem('Doc_APIKey') == null){
    let tmpKeyValue = fetchAPIKey()
    if(tmpKeyValue != null){
