...
// @version      0.2
// @description  Automatically likes ad from the AllianceLeaderName.
// @author       You
// @match        https://politicsandwar.com/*
// @icon         https://www.google.com/s2/favicons?domain=politicsandwar.com
// @updateURL   https://raw.githubusercontent.com/michalani/PNW-Scripts/master/AdAutoLiker.js
// @grant        none
// ==/UserScript==

let AllianceLeaderName = 'Edward the Elder';

setTimeout(
    function() {
        if(document.querySelector('div.hidden-xs.alert.alert-info p.bold a').textContent == AllianceLeaderName)
            try {
